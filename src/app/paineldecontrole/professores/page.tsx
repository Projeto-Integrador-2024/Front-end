    ...
    <div>
        <Table className="max-w-[600px] w-full mx-auto border mt-[10%]">
          <TableCaption className="caption-top text-3xl font-bold mb-[2%]">Lista de professores.</TableCaption>
            ...
            <TableBody>
              <TableRow>
                <TableCell className="font-medium">12312</TableCell>
                <TableCell className="text-center">Foleiss</TableCell>
                <TableCell className="text-center">090.090.090-09</TableCell>
                <TableCell className="text-center">Ciência da Computação</TableCell>
              </TableRow>

              <TableRow>
                <TableCell className="font-medium">645634</TableCell>
                <TableCell className="text-center">Hubner</TableCell>
